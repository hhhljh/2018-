					...
					<tbody>
						<?php foreach ($list as $data): ?>
							<tr>
								...
								<td>
									<button type="button" onclick="location.href ='<?php echo HOME_URL ?>/member/member_update/{$data->idx}'; return false;">수정</button>
									<button type="button" onclick='if(!confirm("삭제하시곘습니까?")) return false; location.href="<?php echo HOME_URL ?>/member/delete/{$data->idx}"'>삭제</button>
								</td>
							</tr>
						<?php endforeach ?>
<!-- 						<tr>
