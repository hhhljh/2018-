<?php 
	function query($sql){
		$db = new PDO("mysql:host=127.0.0.1;dbname=0401;charset=utf8","root","");
	...
	function outShare(){
		query("UPDATE outfile_list FROM cnt=cnt+1 WHERE idx='{$idx}'");
		$data = "INSERT INTO outfile_list
							...
							f.size as size
				FROM 	outfile_list o
				join	member m o.midx = m.idx
				join	files f o.fidx = f.idxs
				where o.ukey = '{$ukey}' 
		";
